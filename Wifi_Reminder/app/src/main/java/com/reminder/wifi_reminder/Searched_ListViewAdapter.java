...
public class Searched_ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (is_night)
                convertView = inflater.inflate(R.layout.searched_listview_item_night, parent, false);
            else
                convertView = inflater.inflate(R.layout.searched_listview_item, parent, false);
        }
