...
public class ViewPageAdapter extends RecyclerView.Adapter<ViewPageAdapter.MyViewHolder> {
    ...
    public ViewPageAdapter(Activity activity, ArrayList<Integer> image_id, ArrayList<String> title, ArrayList<String> content) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.bind_page(images_id.get(position), permission_title.get(position), permission_content.get(position));
    }
